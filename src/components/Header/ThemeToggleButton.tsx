...
const icons = [
	<svg key="light" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
		<path
			fillRule="evenodd"
	...
	<svg key="dark" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
const ThemeToggle = ({ labels, isInsideHeader }: Props) => {
	...
	useEffect(() => {
		...
		document?.firstElementChild?.setAttribute('color-scheme', theme ?? 'light');
	}, [theme]);
