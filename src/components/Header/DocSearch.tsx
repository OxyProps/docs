...
export default function Search({ lang = 'en', labels }: Props) {
	...
	return createPortal(
		<DocSearchModal
			...
			indexName="astro"
			appId="9QOOANPBU8"
			apiKey="1d582f72d8b3809fcd8476f022541284"
			searchParameters={{ facetFilters: [[`lang:${lang}`]] }}
			getMissingResultsUrl={({ query }: { query: string }) => `https://github.com/OxyProps/docs/issues/new?title=Missing+results+for+query+%22${encodeURIComponent(query)}%22`}
