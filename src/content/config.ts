...
export const integrationSchema = baseSchema.extend({
	...
	title: z.string().refine((title) => title.startsWith('@astrojs/'), '"title" must start with "@astrojs/" for integration docs.'),
...
const docs = defineCollection({
	schema: z.union([baseSchema, cmsSchema, integrationSchema, migrationSchema, tutorialSchema, deploySchema, recipeSchema]),
});
