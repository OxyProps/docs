...
:::announcement[OxyProps v1.7 is now available!]
...
<BuilderTabs>
	<Fragment slot="bricks">
		<ContentImage
			coverImage="/images/brx-tracking-context-menu.webp"
	...
	<Fragment slot="oxygen">
		<ContentImage
			coverImage="/images/oxy-leading-context-menu.webp"
			caption="The OxyProps leading (aka line height) context menu in Oxygen editor."
