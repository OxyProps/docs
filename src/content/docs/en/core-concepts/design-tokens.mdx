...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://docs.oxyprops.com/open-graph/core-concepts/design-tokens.png
  - tag: meta
    attrs:
...
In this example, the `hsl()` function with the parameters defining the base indigo color is stored in a human readable [css custom property](/core-concepts/css-custom-properties/) as a global design token.
