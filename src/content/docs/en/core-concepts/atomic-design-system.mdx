...
The IBM’s Carbon icon set is available in the OxyProps [Unlimited Icon](/en/elements/icon-element/) Element using the following syntax: carbon\:icon-name. For example, carbon\:home will get you this icon:  
<Icon name="carbon:home" size={24} />
:::
...
The Google's Material Symbols icon set is available in the OxyProps [Unlimited Icon](/en/elements/icon-element/) Element using the following syntax: material-symbols\:icon-name  For example, carbon\:home will get you this icon:  
...
More about design tokens in the [design tokens](/en/core-concepts/design-tokens/) dedicated documentation page.
:::
...
- <a href="https://atomicdesign.bradfrost.com/" target="_blank">Atomic Design Methodology</a>,  by Brad Frost
