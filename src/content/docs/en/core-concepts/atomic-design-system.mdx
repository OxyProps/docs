...
- **<a href="https://carbondesignsystem.com/" target="_blank">IBM Carbon Design System</a>**  
  ...
  The IBM’s Carbon icon set is available in the OxyProps [Unlimited Icon](/en/elements/icon-element/) Element using the following syntax: `carbon:icon-name`.
...
- **<a href="https://m3.material.io/" target="_blank">Material Design by Google</a>**  
  ...
  The Google's Material Symbols icon set is available in the OxyProps [Unlimited Icon](/en/elements/icon-element/) Element using the following syntax: `material-symbols:icon-name`   For example:
  ```sh
...
direction: right
atoms: {shape: circle }
molecules: {shape: circle }
organisms: {shape: circle }
pages: {shape: document }
templates: {shape: document }
